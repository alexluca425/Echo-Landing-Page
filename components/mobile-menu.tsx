...
export const MobileMenu = ({ className, onJoinClick }: MobileMenuProps) => {
          ...
          <nav className="flex flex-col space-y-6 container mx-auto">
            ...
            <div className="mt-6">
              <button
                ...
                className="text-xl font-mono uppercase text-primary transition-colors ease-out duration-150 hover:text-primary/80 py-2"
              >
                Join waitlist
              </button>
            </div>
