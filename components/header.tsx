  ...
  return (
    <div className="fixed z-50 pt-8 md:pt-14 top-0 left-0 w-full bg-gradient-to-b from-black/80 to-transparent pointer-events-none">
      <div className="container pointer-events-auto">
        <header className="relative flex items-center justify-between bg-foreground/5 border border-foreground/10 rounded-lg px-4 md:px-6 py-3 md:py-4 backdrop-blur-md">
        <Link href="/">
